...
#define USBD_PID          0x4711

#define GPIO_PIN_UART1_TX GPIO_PIN_10
#define GPIO_PIN_UART1_RX GPIO_PIN_12
#define GPIO_PIN_EN       GPIO_PIN_14
#define GPIO_PIN_BOOT     GPIO_PIN_16
...
#define CONFIG_USBHOST_MAX_RNDIS_CLASS   0
