...
//TH		8'h75: MCODE_S1 = {`mcLDN,`mcrN,`mcrn,`mcrE,`mcpN,`amP1,`pcI};		// EIM#,($nnnn)
		8'h75: MCODE_S1 = {`mcLDN,`mcrM,`mcrn,`mcrE,`mcpN,`amP1,`pcI};		// EIM#,($nn)
...
//TH		8'h75: MCODE_S2 = {`mcLOR,`mcrM,`mcrE,`mcrE,`mcpN,`amP1,`pcI};		// EIM#,($nnnn)
		8'h75: MCODE_S2 = {`mcEOR,`mcrT,`mcrM,`mcrT,`mcpN,`amE0,`pcI};		// EIM#,($nn)
...
//TH		8'h75: MCODE_S3 = {`mcEOR,`mcrT,`mcrM,`mcrT,`mcpN,`amE0,`pcI};		// EIM#,($nnnn)
		8'h75: MCODE_S3 = {`mcLDN,`mcrT,`mcrn,`mcrM,`mcpN,`amE0,`pcN};		// EIM#,($nn)
...
//TH		8'h75: MCODE_S4 = {`mcLDN,`mcrT,`mcrn,`mcrM,`mcpN,`amE0,`pcN};		// EIM#,($nnnn)
                8'h75: MCODE_S4 = `MC_NEXTI;		                                // EIM#,($nn)
